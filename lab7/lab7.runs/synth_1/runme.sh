...
HD_PWD='C:/Users/Admin/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeGameTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SnakeGameTop.tcl
