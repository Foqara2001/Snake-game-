...
HD_PWD='C:/Users/Admin/lab7/lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeGameTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SnakeGameTop.tcl -notrace
